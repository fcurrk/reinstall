...
function Start() {
  ...
  wget --no-check-certificate -qO /tmp/Core_Install.sh 'https://raw.githubusercontent.com/fcurrk/reinstall/master/Core_Install_2020.sh' && chmod a+x /tmp/Core_Install.sh
